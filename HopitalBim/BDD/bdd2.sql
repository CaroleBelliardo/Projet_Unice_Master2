CREATE TABLE Adresses (
  idAdresse            varchar(10) NOT NULL, #AUTO_INCREMENT 
  numero               varchar(6), 
  ...
  INDEX (CodesPostauxvilles)); # type=InnoDB
...
CREATE TABLE Interventions (
  ...
  FOREIGN KEY (ServicesnomService) REFERENCES Services (nomService) ON DELETE SET NULL ON UPDATE CASCADE,
  FOREIGN KEY (InterventionsPathoPathologiesidPatho) REFERENCES InterventionsPatho (PathologiesidPatho) ON DELETE SET NULL ON UPDATE CASCADE,
  INDEX (ServicesnomService)); 
