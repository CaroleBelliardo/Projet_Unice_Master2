<div class="containerFormu">
	...
	<!-- ne pas mettre type="email", type non supporté par I.E et safari -->	
			...
			<legend> Adresse du patient </legend> <!-- Titre du fieldset --> 
				...
				<input type="text" class="" name="text_rue"    pattern="[A-Za-z]{1-100}" title="Caractère alphabétique, 100 caractères maximum" placeholder="<?php echo $patientInfo['rue'] ;?>" value="<?php if(isset($error)){echo $text_rue;}else {echo $patientInfo['rue'];}?>" /><br>
